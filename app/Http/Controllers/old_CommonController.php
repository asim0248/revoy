	 ...
	 public function contact_agent_prop(Request $request) {
		$data = array();
            ...
            $msg	="<table width='100%' border='0' cellpadding='0' cellspacing='10' bgcolor='#FFFFFF' align='center' style='background-color: #e5e5e5; padding: 20px 0;'>
                  	...
                  	<tr>
                   	  	<td valign='top' style='color:#044235;'><span style='font-weight:bold;'> First Name : </span> ".$request->contact_agent_first_name_prop." </td>
                   	</tr>
			...
			$msg = '<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto; background-color: #f3f5fb; border-collapse: collapse; border: 1px solid #ddd;">
        <tbody><tr>
        ...
        <tr>
                ...
                <table class="responsive-table" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                    <tbody><tr>
                        ...
                        <td style="padding: 10px; text-align: left;">
                            ...
                            <a href="mailto:'.$rs_agents['email'].'" style="display: inline-block; padding: 10px 20px; background-color: #044235; color: #ffc50b; text-decoration: none; font-size: 18px; border-radius: 5px; margin-top: 10px;">Contact Now</a>
                        </td>
                    </tr>
                </tbody></table>
            </td>
			...
			$data_email = array('name' => '', 'msg' => $msg,'listing_link'=>$listing_link, 'subject' => $subject_header , 'property_option' => $request->property_option_prop, 'property_address' => $request->property_address_prop);
	 ...
	 public function load_video(Request $request) {
	  ...
	  public function load_property_type_filter(Request $request) {
	   ...
	   public function load_near_by(Request $request) {
		...
		$html .= '<div class="recent-search-item" onclick="copy_address(\''.$request->filter.'\','.$k.')">
					<a href="javascript:void(0)" onclick="copy_address(\''.$request->filter.'\','.$k.')">
