        ...
        var grid = new Datatable();
            ...
            grid.init({
                ...
                dataTable: {  
					...
					"fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
						...
						$('td:eq(8)', nRow).attr("id", 'row_header_'+aData[1]);
						$('td:eq(9)', nRow).attr("id", 'row_footer_'+aData[1]);
                    ...
                    "sAjaxSource": "<?=URL::to('admin/properties/listing')?>", // ajax source
           ...
           grid.getTableWrapper().on('click', '.table-group-action-submit', function(e){
                ...
                if (action.val() != "" && grid.getSelectedRowsCount() > 0) {
					...
					$.post('<?=URL::to('admin/properties/listing')?>', {'_token':'<?=csrf_token()?>'}, function (json) {
    ...
    function delete_record(id) {
        ...
        bootbox.confirm('<div class="alert alert-danger alert-error" style="font-size:18px; margin-top: 20px;" >Are you sure you want to delete this ?</div>', function (result) {
            ...
            if (result) {
                ...
                window.location = "<?= URL::to('admin/properties/delete') ?>/" + id;
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/admin/properties/index.blade.php ENDPATH**/ ?>