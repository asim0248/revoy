                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="agent-det-listHead">
                          <h2 class="welcome__content--title">Edit Listing</h2>
                          <p class=""></p>
                        </div>
                      </div>
                      <div class="col-12">
                          ...
                          <div class="tab-body">
                          	<form action="<?=url('/')?>/update-property" method="post" name="form_add_data" id="form_add_data">
                                ...
                                <div id="listing-details" class="tab-section current">
                                    ...
                                    <div class="detail-port-div detail-port-div-bg">
                                         <div class="row list-det-padBot" id="id_show_package" style="<?=($result_property['category_id']==1)?'':'display:none;'?>">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                      ...
                                      <div class="about-listing">
                                          <div class="pass-input">
                                            ...
                                            <div class="pass-input cls_sold " style="<?=($result_property['category_id']==3)?'':'display:none;'?>" >
                                            ...
                                            <div class="pass-input cls_leased_date " style="<?=($result_property['category_id']==4)?'':'display:none;'?>" >
                                            ...
                                            <div class="pass-input" id="cls_sold_type_property_type_id" style="<?=($result_property['category_id']==3)?'display:none;':''?> <?=($result_property['category_id']==4)?'display:none;':''?>">
                                            ...
                                            <div class="list-pass-input" style="margin-bottom: 20px;  <?=($result_property['category_id']==1)?'':'display:none;'?>" id="id_underContract">
                                            ...
                                            <div class="list-pass-input cls_sold_type" style="<?=($result_property['category_id']==3)?'display:none;':''?> <?=($result_property['category_id']==4)?'display:none;':''?>">
                                            ...
                                            <div class="pass-input" >
                                              ...
                                              <option value="">Select Agent</option>
                                                <?php foreach ($rs_agents as $row_u){?>
                                                <option value="<?=$row_u['id']?>" <?=($result_property['assestant_user_id']==$row_u['id'])?'selected':''?>><?=$row_u['name']?></option>
                                                <?php } ?>
                                              </select>
                                              
                                            </div>
                                            
                                            <div class="list-pass-input" id="id_show_show_assestant" style="<?=($result_property['assestant_user_id']!='')?'':'display:none;'?>" >
                                            	<label class="mb-0">
                                                  <input type="checkbox" name="show_assestant_user" id="show_assestant_user" value="1"  <?=($result_property['show_assestant_user']==1)?'checked':''?>> Show Assistant Agent on Detail Page
                                                  
                                                </label>
                                            </div>
                                            <div class="pass-input cls_sold_type" style="<?=($result_property['category_id']==3)?'display:none;':''?> <?=($result_property['category_id']==4)?'display:none;':''?>">
                                            ...
                                            <div class="pass-input cls_sold_type" style=" <?=($result_property['category_id']==3)?'display:none;':''?> <?=($result_property['category_id']==1 || $result_property['category_id']==2)?'':'display:none;'?> ">
                                              <label for="price">Price <span id="show_per_week" style="color:#000; <?=($result_property['category_id']==2)?'':'display:none;'?>">/ Per Week</span> <span>*</span>
                                              <div class="tooltip-container">
                                                <button class="tooltip-icon" type="button">?</button>
                                                <div class="tooltip-message">
                                                  Price will display on the property unless the option to hide price is used. Enter price without comma and Dollar($) sign
                                                </div>
                                              </div>
                                              </label>
                                            ...
                                            <div class="pass-input cls_sold_type_bound" id="show_bond_input" style="<?=($result_property['category_id']==2)?'':'display:none;'?>">
                                              <label for="bond">Bond </label>
                                              <input type="text" id="bond" name="bond" value="<?=$result_property['bond']?>">
                                            ...
                                            <div class="list-pass-input">
                                              ...
                                              <input type="text" class="hid-p-list" name="min_price" id="min_price" value="<?=$result_property['min_price']?>" placeholder="$440,000 - $480,000">
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="property-address">
                                            ...
                                            <div class="pass-input">
                                              ...
                                              <input type="text" name="postcode" id="postcode" placeholder="Enter post code" value="<?=$result_property['postcode']?>">
                                            </div>
                                            <div class="pass-input">
                            ...
                            <div id="property-detail" class="tab-section">
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="pass-input">
                                        ...
                                        <input type="number" id="ensuites" name="ensuites" min="0" value="<?=$result_property['ensuites']?>" >
                                      </div>
                                      <div class="pass-input">
                                        <label for="toilets">Toilets</label>
                                        <input type="number" min="0" id="toilets" name="toilets" value="<?=$result_property['toilets']?>">
                                      </div>
                                      <div class="pass-input" >
                                        <h3>Parking</h3>
                                        <label for="garage spaces">Garage Spaces</label>
                                        <input style="margin-bottom: 12px !important;" type="number" name="garage_spaces" min="0" id="garage_spaces" placeholder="garage spaces" value="<?=$result_property['garage_spaces']?>">
                                        <label for="carport spaces">Carport Spaces</label>
                                        <input style="margin-bottom: 12px !important;" type="number" name="carport_spaces" min="0" id="carport_spaces" placeholder="carport spaces" value="<?=$result_property['carport_spaces']?>">
                                        <label for="open spaces">Open Car Spaces
                                         <div class="tooltip-container">
                                          <button class="tooltip-icon" type="button">?</button>
                                          <div class="tooltip-message">
                                        ...
                                        <input type="number" min="0" name="popen_spaces" id="popen_spaces" placeholder="Open Car Spaces" value="<?=$result_property['popen_spaces']?>">
                                      ...
                                      <div class="pass-input cls_h_size" style="<?=($result_property['category_id']==2)?'display:none;':''?>">
                                      ...
                                      <div class="pass-input cls_h_size" style="<?=($result_property['category_id']==2)?'display:none;':''?>">
                                        ...
                                        <div class="house-size">
                                            ...
                                            <input type="number" id="land_size" name="land_size"  value="<?=$result_property['land_size']?>">
                                          </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-12">
                                                    <div class="size-selt" >
                                            <select name="land_size_unit" id="land_size_unit">
                                              <option value="square Meters" <?=($result_property['land_size_unit']=='quare metres')?'selected':''?>>Square meters</option>
                                 ...
                                 <div class="detail-port-div detail-port-div-bg">
                                    <div class="row">
                                    <h3>Search Refinement Options</h3>
                                    <div class="col-lg-12">
                                      <div class="search-refinement-options">
                                          <!-- Outdoor Features -->
                                          <div class="pass-check-input options-group">
                            ...
                            <div id="image-copy" class="tab-section">
                                ...
                                <div class="col-lg-12">
                                    <div class="pass-input">
                                      <label for="headline">Headline<span class="required">*</span></label>
                                                                        <p>
                                    Agent name or contact details should not be entered into the headline field
                                  </p>
                                      <textarea class="headline-textarea" id="name" name="name"
                                      ...
                                      <textarea class="fullcont-textarea" id="full_contents" name="full_contents"
                                ...
                                <div class="col-lg-12">
                                    <div class="property-images">
                                      <div class="main-image">
                                        ...
                                        <?php } ?>
                                        <span style="color:#B2B2B2;">Required Image Size: 800px X 600px (File size should be less than 100kb)</span>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  ...
                                  <button type="button" name="id_btn_submit" id="id_btn_submit_images" class="save-changes-button w-auto">Save Changes</button>
                                    ...
                                    <h3>Create Inspection Times</h3>
                                            ...
                                            <label class="inspection-time-form__label">Pick a Date</label>
                                              <input type="date" class="inspection-time-form__date" name="ins_date" id="ins_date">
                                                ...
                                                <div class="col-xl-6 col-lg-12">
                                            <!-- Start Time Inputs -->
                                            <div class="pass-input">                                      <label class="inspection-time-form__label">Start time</label>
                                              <div class="inspection-time-form__time-group">
                                                ...
                                                <div class="col-xl-6 col-lg-12">
                                            <!-- End Time Inputs -->
                                            <div class="pass-input">                                      <label class="inspection-time-form__label">End time</label>
                                              <div class="inspection-time-form__time-group">
                                      ...
                                      <span style="display:none;" id="id_loading_inspection"><img src="<?=url('/')?>/public/assets/agents/images/input-spinner.gif" /></span>
                                            ...
                                            <div class="properties__table table-responsive" id="list_inspection">
                                                ...
                                                <?php echo $__env->make('accounts.property._inspections',array('rs_inspections'=>$rs_inspections), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    	<div class="col-lg-4">
                            ...
                            <div id="auction" class="tab-section">
                                <div class="detail-port-div detail-port-div-bg">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-xl-6 col-lg-12">
                                        <!-- Start Time Inputs -->
                                        <div class="pass-input">                   <label class="inspection-time-form__label">Time</label>
                                          <?php
                                          $auction_time = array();
...
function showResponse_auction(response, statusText, xhr, $form)  {
	...
	function delete_ins(id) {
        bootbox.confirm('<div class="alert alert-danger alert-error" style="font-size:18px; margin-top: 20px;" >Are you sure you want to delete this ?</div>', function (result) {
            if (result) {
                $('#row_ins_'+id).hide();
			$.post('<?=url('/')?>/delete-property-inspection', {'_token':'<?php echo e(csrf_token()); ?>','id':id}, function (data) {
				var obj = eval(data);
	...
	function delete_img(id) {
        bootbox.confirm('<div class="alert alert-danger alert-error" style="font-size:18px; margin-top: 20px;" >Are you sure you want to delete this ?</div>', function (result) {
            if (result) {
                $('#row_id_'+id).hide();
			$.post('<?=url('/')?>/delete-property-images', {'_token':'<?php echo e(csrf_token()); ?>','id':id}, function (data) {
				var obj = eval(data);
				if (obj.status == 'success') {
					 Toast.success(obj.message);
	...
	$('#category_id').on('change', function () {
			$('#cls_sold_type_property_type_id').hide();
			if($(this).val()==1){
...
<?php echo $__env->make('layouts.agents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/property/edit.blade.php ENDPATH**/ ?>