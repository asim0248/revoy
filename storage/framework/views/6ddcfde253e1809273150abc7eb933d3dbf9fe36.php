...
$db_property = App\Model\Property::where('status', 'Yes')
    ...
    ->where('category_id', 3)->where('is_new', 'No')
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/sold.blade.php ENDPATH**/ ?>