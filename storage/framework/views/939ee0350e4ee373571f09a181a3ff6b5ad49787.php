                ...
                <div class="account__section--inner">
                    ...
                    <div class="account__tab--btn">
                        ...
                        <ul class="account__tab--btn__wrapper d-flex justify-content-center">
                            ...
                            <li class="account__tab--btn__items"><a class="account__tab--btn__field" href="<?=url('/')?>/login-customer">Login</a></li>
                    ...
                    <div class="account__form--wrapper">
                        ...
                        <div class="account__header text-center mb-30">
                            ...
                            <h2 class="account__title">Customer Sign Up Here!</h2>
                        ...
                        <div class="account__form">
                            ...
                            <form class="form-horizontal" action="" name="form_register" id="form_register" method="post">
                                ...
                                <button class="account__form--btn solid__btn" type="button" id="id_btn_submit" onclick="register_customer()">Signup Here</button>
...
<script>
    ...
    if (flg == 0) {
        ...
        $.post(path_url+"/signup", $('#form_register').serialize(), function (data) {
            var obj = eval(data);
...
<?php echo $__env->make('layouts.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/register_customer.blade.php ENDPATH**/ ?>