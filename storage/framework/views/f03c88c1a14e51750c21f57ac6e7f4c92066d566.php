...
<div class="page__body--wrapper" id="dashbody__page--body__wrapper">
            ...
            <main class="main__content_wrapper">
             <form action="<?=url('/')?>/save-agent" method="post" name="form_add_data" id="form_add_data">
                            <input type="hidden" id="_token" name="_token" value="<?=csrf_token()?>">
                <div class="dashboard__container dashboard__reviews--container">
                    <div class="agent-det-listHead">
                        <h2 class="reviews__heading--title mt-3">Add New Agent</h2>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="detail-port-div">
                                        ...
                                        <div class="pass-input">                    <label for="">Email</label>
                                        <input type="text" name="email" id="email">
                                        </div>
                                        <div class="pass-input">                    <label for="">Password</label>
...
$currentYear = date("Y");
                                        ...
                                        <div class="pass-input">
                                            ...
                                            <input type="text" name="license_number" id="license_number" value=""> 
                                        </div>
                                        </div>
                                    <div class="detail-port-div">
                                        ...
                                        <label class="upload-area" for="file-upload">
                                            ...
                                            <p>
                                                A cover photo adds personality        and character to your profile page.     Choose a clear photo with you or your     scene as the focal point. The image     must be a minimum of 1280 x 400         pixels, and may be a JPEG or PNG
                                                </p>
                                        </div>
                                    </div>    
                                    </div>
...
The video will be displayed above the banner on agent profile page.
                                    ...
                                    <div class="detail-port-div">
                                        ...
                                        <div class="pass-input">                     <label for="">About Description</label>
                                    <textarea style="width: 100%; padding: 10px 8px;  border: 1px solid var(--color-border);
  background-color: var(--color-background-3);" name="full_contents" id="full_contents" class="w-100" rows="6"></textarea>
                                        </div>
                                        <div class="pass-input">
                                            <label for="">Tagline</label>
                                    <textarea style="width: 100%; padding: 10px 8px;  border: 1px solid var(--color-border);
  background-color: var(--color-background-3);" name="tagline" id="tagline" class="w-100" rows="3"></textarea>
                                        </div>
                                        <div class="pass-input">
                                            <label for="">Awards</label>
                                    <textarea style="width: 100%; padding: 10px 8px;  border: 1px solid var(--color-border);
  background-color: var(--color-background-3);" name="awards" id="awards" class="w-100" rows="6"></textarea>
                                        </div>
                                        <div class="pass-input">
                                            <label for="">Specialities</label>
                                    <textarea style="width: 100%; padding: 10px 8px;  border: 1px solid var(--color-border);
  background-color: var(--color-background-3);" name="specialities" id="specialities" class="w-100" rows="6"></textarea>
                                        </div>
                                        <div class="pass-input">
                                            <label for="">Community Involvement</label>
                                    <textarea style="width: 100%; padding: 10px 8px;  border: 1px solid var(--color-border);
  background-color: var(--color-background-3);" name="community_involvement" id="community_involvement" class="w-100" rows="6"></textarea>
                                        </div>
                                    </div>
                                    <div class="detail-port-div">
                                        <h3>Social Media Profiles Links</h3>
                                        <p>
                                            Used correctly, social media can        help you build your brand and foster     a real connection with vendors,         buyers and landlords. It could also     help You win more things and move     properties faster. 
                                        </p>
                                        <div class="pass-input">
...
<?php echo $__env->make('layouts.agents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/agency/agents/add.blade.php ENDPATH**/ ?>