...
The video will be displayed above the banner on your agency profile page.
                                    ...
                                    <span class="" style="display:none;"  id="id_loading"><img src="<?php echo e(url('/')); ?>/public/assets/main/images/loading_small.gif" /></span>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.agents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/agency/agency_profile/index.blade.php ENDPATH**/ ?>