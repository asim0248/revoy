...
<article class="featured__card">
   <div class="featured__thumbnail position-relative">
                                                <div class="media">
                                                    <a class="featured__thumbnail--link" href="<?=url('/')?>/detail/<?=$row_p->slug?>-<?=$row_p->id?>.html"><img
                                                            class="featured__thumbnail--img"
                                                            src="<?= url('/') . '/public/upload/property/'.$row_p->id.'/'.$row_p->image?>"
                                                            alt="<?=$row_p->name?>"></a>
                                                </div>
                                                <div class="featured__badge">
                                                    <ul class="prop-crd-tick">
                                                        <li>
   ...
   <div class="featured__content">
                                                <div
                                                    class="featured__content--top">
                                                    <h3 class="featured__card--title"><a class="card-tit-sm" href="<?=url('/')?>/detail/<?=$row_p->slug?>-<?=$row_p->id?>.html"><?=$row_p->name?></a></h3>					
                                                    
													
                                                    
                                                    <?php if($row_p->hide_price_show_contact_agent==0){?>
													<?php if($row_p->show_price==1){?>
                                                    <span class="featured__card--price"><?=App\Model\Common::priceFormat($row_p->price)?> <?=($row_p->category_id==2 or $row_p->category_id==4)?'Per Week':''?></span>
                                                    <?php } else if($row_p->show_price==1 && $row_p->category_id==3 && $row_p->sold_price!=''){?>
                                                    <span class="featured__card--price"><?=App\Model\Common::priceFormat($row_p->sold_price)?></span>
                                                    <?php } else {?>
                                                    <span class="featured__card--price"><?=$row_p->min_price?></span>
                                                    <?php } ?>
                                                     <?php } else { //isset($row_p->agent->phone)?$row_p->agent->phone:''?>
                                                    <span class="featured__card--price">Contact Agent</span>
                                                    <?php } ?>
                                                ...
                                                <p class="featured__content--desc"><svg width="11" height="17"
                                                ...
                                                <ul class="featured__info d-flex">
                                                    ...
                                                    <li class="featured__info--items">
                                                        <span class="featured__info--icon">
                                                             <?=$row_p->bedrooms?>
                                                            <!--<svg width="25" height="21" viewbox="0 0 25 17" fill="none"-->
                                                            <!--    xmlns="http://www.w3.org/2000/svg">-->
                                                            <!--    <path-->
                                        ...
                                        <i class="fa-solid fa-bath"></i>                    
                                                    ...
                                                    <li class="featured__info--items">
                                                        ...
                                                        <span class="featured__info--text">Car Parking</span>
                                                    </li>
                                                    <?php } ?>
                                                    ...
                                                    <li class="featured__info--items">
                                                        <span class="featured__info--icon">
                                                            <?=$row_p->land_size?>
                                                            <!--<svg width="19" height="20" viewbox="0 0 18 18" fill="none"-->
                                                            <!--    xmlns="http://www.w3.org/2000/svg">-->
                                                            <!--    <path-->
                                            ...
                                            <i class="fa-solid fa-maximize"></i>
                                                ...
                                                <div
                                                    class="featured__content--footer d-flex align-items-center justify-content-between">
                                                    <div class="featured__author d-flex align-items-center">
                                                        <span class="featured__author--img position-relative">
                                                            
                                                             <?php if(isset($row_p->agent->image) &&  $row_p->agent->image!="") {?>
                                   								 <img src="<?= url('/') . '/public/upload/agents/' . $row_p->agent->image ?>" style="width:34px; height:34px;" >
																<?php }else {?>
                                                                <img  src="<?=url('/')?>/public/assets/agents/img/dashboard/nav-author-thumb.png" alt="">
                                                                
                                                                <?php } ?>				                                                                
                                                                
                                                        </span>
                                                        <span class="featured__author--name"><?=(isset($row_p->agent->name)?$row_p->agent->name:'')?></span>
                                                    </div>
...
<?php } ?>
<?php } ?><?php /**PATH /home/revoycom/public_html/resources/views/common/_item_property.blade.php ENDPATH**/ ?>