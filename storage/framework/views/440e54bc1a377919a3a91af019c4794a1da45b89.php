                ...
                <div class="dashboard__container d-flex">
                    <div class="main__content--left">
						...
						?>
                                    ...
                                    <span class="" style="display:none;"  id="id_sync_loading"><img src="<?php echo e(url('/')); ?>/public/assets/main/images/loading_small.gif" /></span>
                                    </div>
                                    </div>
                                </form>
                            </div>
...
<?php echo $__env->make('layouts.agents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/profile_crm/index.blade.php ENDPATH**/ ?>