    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/pages/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal"  onsubmit="return edit_page();" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo App\Model\Cms::fillComboCMS($data['p_id']);?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control"  placeholder="" name="image_title" id="image_title" ><?= $data['image_title'] ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="meta_keyword" id="meta_keyword" value="<?= $data['meta_keyword'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control"  placeholder="" name="meta_description" id="meta_description"><?= $data['meta_description'] ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="file" class="" style="display:none;"  placeholder="" name="icon" id="icon" value=""><br />
                                <?php if($data['icon']!="") {?>
                                <img src="<?= url('/') . '/public/upload/cms/' . $data['icon'] ?>" height="50" width="50" />
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($data['image']!="") {?>
                                <img src="<?= url('/') . '/public/upload/cms/' . $data['image'] ?>" height="80" width="80" />
                                <?php } ?>
                        ...
                        <div class="form-group" style="">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($data['banner']!="") {?>
                                <img src="<?= url('/') . '/public/upload/cms/' . $data['banner'] ?>" height="80" width="80" />
                                <?php } ?>
                       ...
                       <div class="form-group"  >
                            ...
                            <div class="col-md-8">
                                <textarea class=" form-control"  name="extra_detail" id="extra_detail"><?= $data['extra_detail'] ?></textarea><script type="text/javascript">
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/admin/cms/edit.blade.php ENDPATH**/ ?>