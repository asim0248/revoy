    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/widgets/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal"  enctype="multipart/form-data"  onsubmit="return update_widgets();">
                    ...
                    <div class="form-body">
                        <div id="id_alert" class="alert alert-danger display-hide ">
                          ...
                          <div class="form-group" >
                            <label class="col-md-3 control-label">Widget Type <span class="required">*</span></label>
                            <div class="col-md-4">
                               <select class="form-control"   name="banner_type" id="banner_type">
                                <option value="1" <?=($data['banner_type']==1)?'selected':''?>>Vertical </option>
                                <option value="2" <?=($data['banner_type']==2)?'selected':''?>>Horizantal </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control"  placeholder="" name="page_name" id="page_name" value="<?= $data['page_name'] ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($data['image']!="") {?>
                               <img src="<?= url('/') . '/public/upload/widgets/' . $data['image'] ?>" width="300" />
                                <?php } ?>
                    ...
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?= URL::to('admin/widgets') ?>"><button type="button" class="btn default"  > Cancel</button></a>
                        </div>
                    </div>
                </form>
                <!-- END FORM-->
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/admin/widgets/edit.blade.php ENDPATH**/ ?>