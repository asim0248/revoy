            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-8 col-lg-8">
                        <div class="estimate-form-main">
                            <div class="estimate-header">
                                <h2>Get Subrub Property Estimate</h2>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="explore-mob-img">
                        	<?php if($cms_dp['image']!=''){?>
                            <img style="margin: 0 auto;" src="<?=$cms_dp['image']?>" alt="">
                            <?php } ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/explore_suburb_profiles_form.blade.php ENDPATH**/ ?>