                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="agnt-lft-main">
                                <div class="agent-left">
                                    ...
                                    <form action="<?=url('/')?>/search-tenant.html" method="get">
                                        <input type="text" placeholder="Enter Suburb of property for rent" name="keyword">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12">
                        <div class="estimate-form-main">
                            <div class="estimate-header">
                                <h2>Finding good tenants have never been easier
                                </h2>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/find_tenant_form.blade.php ENDPATH**/ ?>