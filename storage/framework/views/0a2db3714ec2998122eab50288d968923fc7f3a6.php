...
<?php $__env->startSection('content'); ?>
     ...
     <!-- Start Hero section -->
                        ...
                        <div class="agent-hero-main">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-12">
                                    <div class="agnt-lft-main loan-det-left">
                                        <div class="loan-left">
                                            <?php if($cms_dp['image_3']!='') {?>
                                            <img src="<?=$cms_dp['image_3']?>" alt="">
                                        	<?php } ?>
                                            
                                            <h1><?=$cms_dp['heading']?></h1>
                                            <h2><?=$cms_dp['sub_heading']?></h1>
                                        </div>
                                    </div>
                                ...
                                <form action="" id="contact-form-loan" name="contact-form-loan"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                            <div class="estimate-input">
                                                <input type="text" placeholder="Full Address" name="contact_loan_address" id="contact_address" >
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                            <div class="estimate-input">
                            ...
                            <div class="esti-side">
                               <?=$cms_dp['full_contents']?>
                                <div class="esti-btn loan-request">
                                    ...
                                    <a href="mailto:info@revoy.com.au"><i class="fa-solid fa-envelope"></i>info@revoy.com.au</a>
                                </div>
        ...
        <?php echo $__env->make('common.bottom_news',array('blog_title'=>$cms_dp['blog_title'],'blog_slug'=>$cms_dp['slug']), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/loan-detail.blade.php ENDPATH**/ ?>