            ...
            <div class="dashboard__container d-flex">
                    <div class="main__content--left">
                        <div class="main__content--left__inner">
                            <!-- Welcome section -->
                             <form action="<?=url('/')?>/save-saleperson" method="post" name="form_add_data" id="form_add_data">
...
<?php echo $__env->make('layouts.agents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/salepersons/add.blade.php ENDPATH**/ ?>