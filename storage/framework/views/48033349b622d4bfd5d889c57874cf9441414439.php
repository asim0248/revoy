...
//$db_property = App\Model\Property::whereRaw("status = 'Yes' AND is_featured='Yes' AND admin_status = 'Yes' AND category_id  = 3  ")->orderByRaw('id DESC')->get();
...
<section class="featured__section color-accent-2 sold-feat-sec">
            <div class="container">
                ...
                <div class="featured__inner position-relative" data-aos="fade-up" data-aos-duration="1200"
                    ...
                    <?php 
                        ...
                        <div class="swiper-wrapper">
                           <?php echo $__env->make('common._item_property',array('db_property'=>$db_property,'from_page'=>'buy'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
	   ...
	   <?php if(count($widget_dp)>0) {?>
        <section class="lead-belt sold-belt" style="background-image: url('<?= url('/') . '/public/upload/widgets/' . $widget_dp[0]['image'] ?>');">
            <div class="container">
                <div class="row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/leased.blade.php ENDPATH**/ ?>