    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/widgets/create_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal"   enctype="multipart/form-data" onsubmit="return create_widgets();" >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group"  >
                            ...
                            <div class="col-md-4">
                               <select class="form-control"   name="banner_type" id="banner_type">
                                ...
                                <option value="2">Horizantal </option>
                        ...
                        <div class="form-group" style="display:none;">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control"  placeholder="" name="page_name" id="page_name" />
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/admin/widgets/add.blade.php ENDPATH**/ ?>