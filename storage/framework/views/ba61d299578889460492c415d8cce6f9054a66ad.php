...
$video_latest_dp = App\Model\Videos::whereRaw("status = 'Yes'  ")->orderByRaw('id DESC')->take(8)->get()->toArray();
$video_popular_dp = App\Model\Videos::whereRaw("status = 'Yes' AND is_popular = 'Yes' ")->orderByRaw('id DESC')->take(8)->get()->toArray();
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-12">
                        ...
                        <input type="hidden" value="" name="filter_type" id="filter_type">
                    ...
                    <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-12">
                        ...
                        <div class="main-content">
                            ...
                            <div class="row main_data" >
                                <div class="col-12">
                                    <div class="newsVideo-head">
                                        <h2>Most Recent</h2>
                                    </div>
                                </div>
                                
                                
                                <?php echo $__env->make('common._video',array('result_video'=>$video_latest_dp), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="row main_data">
                                ...
                                <?php echo $__env->make('common._video',array('result_video'=>$video_popular_dp), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/blog_videos.blade.php ENDPATH**/ ?>