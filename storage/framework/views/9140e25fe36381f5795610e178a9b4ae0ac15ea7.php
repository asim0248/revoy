                        ...
                        <div class="properties__wrapper branding-wrapper" style="background: #fff;">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <span class="" style="display:none;"  id="id_loading_process"><img src="<?php echo e(url('/')); ?>/public/assets/main/images/loading_small.gif" /></span></div>
...
<?php echo $__env->make('layouts.agents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/accounts/agency/agency_branding/index.blade.php ENDPATH**/ ?>