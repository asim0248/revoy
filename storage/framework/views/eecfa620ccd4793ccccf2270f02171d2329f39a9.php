...
foreach ($settings as $k=>$setting){
 ...
 if($keywords==''){
 	 $rs_brokers = App\Model\Brokers::whereRaw("status = 'Yes' ".$where."  ")->orderByRaw('id DESC')->get()->toArray();
 }else {
	 $rs_brokers = App\Model\Brokers::whereRaw("status = 'Yes'   ")->where('location', 'LIKE',"%{$keywords}%")->orWhere('address', 'LIKE',"%{$keywords}%")->orWhere('post_code', 'LIKE',"%{$keywords}%")->orderByRaw('id DESC')->get()->toArray();
 }
                ...
                <div class="team__member--inner" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-12">
                            <div class="team__member--items broker__dt--card">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/brokers.blade.php ENDPATH**/ ?>