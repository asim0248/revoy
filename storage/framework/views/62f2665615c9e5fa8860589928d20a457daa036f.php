...
$cms_dp['id'] = $cms_dp['parent_agent_id'];
...
$rs_agents = array();// App\Model\Agents::whereRaw('( agency_id = '.$cms_dp['id'].' OR  parent_agent_id = '.$cms_dp['id'].' ) AND status = ?  ', array($cms_dp['id'],'Yes'))->orderByRaw('name')->get()->toArray();

//$rs_agents_sales = App\Model\Agents::whereRaw('parent_agent_id = ? AND status = ?  ', array($cms_dp['id'],'Yes'))->orderByRaw('name')->get()->toArray();
if($cms_dp['parent_agent_id']!=0){
	//echo $cms_dp['parent_agent_id']; exit;
	$agancy_detail = App\Model\Agents::whereRaw(" (id = '".$cms_dp['parent_agent_id']."') ")->first()->toArray();
	if($cms_dp['agency_id']!=0){
		...
		$cms_dp['banner'] = $agancy_detail['banner'];
                                ...
                                <div class="listing__details--wrapper">
                                    ...
                                    <div class="listing__details--content" style="display:none;">
                                        ...
                                        <div class="listing__details--content__step">
                                            <h4 class="fs-3 mb-0 pb-1"><?=$cms_dp['name']?>'s Performance Snapshot</h4>
                                            <p>
                                    ...
                                    <div class="listing__details--main__content">
                                        ...
                                        <div class="listing__details--content__step properties__amenities mb-40">
                                            ...
                                            <div class="properties__amenities--wrapper">
                                                <h4 class="fs-3 mb-0 pb-1">About The Team</h4>
                                                <p>
                                            ...
                                            <div class="listing__details--location__header mb-20">
                                                ...
                                                <div class="auction-main">
                                                    ...
                                                    <div class="button-group">
                                                        <button class="option-button" type="button"  onclick="contact_agent_detail_new(<?=$cms_dp['id']?>,'Selling a property')">Selling a property</button>
                                                        <button class="option-button" onclick="contact_agent_detail_new(<?=$cms_dp['id']?>,'Property management')">Property management</button>
                                                        <button class="option-button" onclick="contact_agent_detail_new(<?=$cms_dp['id']?>,'An advertised property')">An advertised property</button>
                                                        <button class="option-button" onclick="contact_agent_detail_new(<?=$cms_dp['id']?>,'General enquiry')">General enquiry</button>
                                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="review-card">
                                                <h3 class="section__heading--title green-bg-head">1. How would you rate Steven's work overall?
                                                </h3>
                                                <div class="rating-container">
                                                    <p id="rating-text">Select a star rating for Steven</p>
                                            ...
                                            <div class="review-card">
                                                <h3 class="section__heading--title green-bg-head">2. Your review of Steven's work
                                                </h3>   
                                            ...
                                            <div class="review-card">
                                                <div class="Your-Property">
                                                    ...
                                                    <p class="mb-0">What did Steven help you with?</p>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 mb-2">
                                                        <div class="contact__form--input position-relative">
                                                            <input name="agent_search_address" id="agent_search_address" class="contact__form--input__field" placeholder="Search For Street address" type="text">
                                            ...
                                            <div class="review-card">
                                                <div class="your-detail">
                                                    ...
                                                    <p>
                                                        your review, for example Jane S (vendor). This helps build trust for other consumers.
                                                    </p>
...
<script>
        ...
        function initMap() {
            ...
            fetch('<?=url('/')?>/common/agent_load_property_data?user_id=<?=$user_id?>')
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/revoycom/public_html/resources/views/agent_sales_detail.blade.php ENDPATH**/ ?>