                        ...
                        <div class="tab-wrapper">
                          ...
                          <div class="tab-body">
                                    ...
                                    <div class="about-listing">
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" id="price" name="price" value="<?=$result_property['price']?>">
                                          <div class="tooltip-container">
                                            <button class="tooltip-icon" type="button">?</button>
                                            <div class="tooltip-message">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="radio-group">
                                            ...
                                            <label>
                                              <input type="radio" name="show_price" id="show_price" value="1" <?=($result_property['show_price']=='1')?'checked':''?>> Show text instead of
                                              price
                                              <div class="tooltip-container">
                                                <button class="tooltip-icon" type="button">?</button>
                                                <div class="tooltip-message">
                                        ...
                                        <div class="form-group">
                                          <label>
                                            ...
                                            <div class="tooltip-container">
                                              <button class="tooltip-icon" type="button">?</button>
                                              <div class="tooltip-message">
                                                TFor Buy listings in NSW, VIC & WA: If you elect to hide the price on the website, 'Contact agent' will show on the Listing page. For Rent listings in NSW: This field is no longer used. Instead, 'Rental Per Week' price is displayed on the listing.
                                              </div>
                                            </div>
                                          </label>
                                        </div>
                                  ...
                                  <div class="bg-gray-listing">
                                      ...
                                      <div class="form-group">
                                        <div class="house-size">
                                          ...
                                          <div class="size-selt" style="<?=($result_property['category_id']==2)?'display:none;':''?>">
                            ...
                            <input type="hidden" id="proper_token" name="proper_token" value="<?=md5($result_property['id'])?>">
                                  ...
                                  <div class="bg-gray-listing">
                                    <div class="listing-copy">
                                      ...
                                      <textarea id="full_contents" name="full_contents"
                                        placeholder="Enter description here"><?=nl2br($result_property['full_contents'])?></textarea>
                                    </div>
                              ...
                              <h2 class="welcome__content--title pb-10">Front Page Image</h2>
                              <div class="row list-det-padBot">
                                <div class="col-lg-12">
                                  <div class="bg-gray-listing">
                                    <p>
                                    ...
                                    <div class="front-page-image">
                                     ...
                                     <input type="file" id="frontPageInput" name="front_page_image" accept="image/*" style="display: none;">
                                  ...
                                  <div class="bg-gray-listing">
                                    <div class="property-images">
                                      ...
                                      <div class="additional-images">
                                        ...
                                        <input type="file" id="additionalImageInput_1" name="images[]" multiple accept="image/*"
                                          style="display: none;">
                                      </div>
                                    </div>
                                  ...
                                  <div class="bg-gray-listing">
                                    <div class="property-images">
                                      ...
                                      <div class="additional-images">
                                        ...
                                        <input type="file" id="additionalImageInput_2" name="images[]" multiple accept="image/*"
                                          style="display: none;">
                                      </div>
                                    </div>
...
$(document).ready(function() {
	var options_images_add = { 
		...
		dataType: 'json' 
 		...
 		$('body').delegate('#additionalImageInput_1','change', function(){
		if(valid_form_images_add()){
			hide_alert();
...
$(document).ready(function() {
	var options_images_floor = { 
		...
		dataType: 'json' 
 		...
 		$('body').delegate('#additionalImageInput_2','change', function(){
		if(valid_form_images_floor()){
			hide_alert();
