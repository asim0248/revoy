...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/public/assets/main/css/plugins/font/flaticon.css ">
  ...
  <div class="page-wrapper">
    ...
    @include('partial.popup')
     ...
     <script src="{{ url('/') }}/public/assets/main/js/jquery.min.js"></script>
   	...
   	<script src="{{ url('/') }}/public/assets/main/js/vendor/popper.js" defer></script>

    <script src="{{ url('/') }}/public/assets/main/js/vendor/bootstrap.min.js" defer></script>
