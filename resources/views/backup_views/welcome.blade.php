...
@section('content')
 ...
 $rs_sections = App\Model\Sections::whereRaw("status = 'Yes' AND is_featured='Yes' AND listing_ids !='' ")->orderByRaw('sort_order')->get()->toArray();
...
<!-- Start Hero section -->
            ...
            <div class="tab-body">
                <?php foreach ($rs_sections as $k=>$row_s) {
					...
					if(count($array_listing_ids)>0){ 
						$db_property = App\Model\Property::whereRaw("status = 'Yes' AND is_featured='Yes' AND id IN(".$row_s['listing_ids'].")  ")->orderByRaw('sort_order DESC')->get();
					}
					?>
                    ...
                    <div class="container">
                        ...
                        <div class="featured__inner position-relative" data-aos="fade-up" data-aos-duration="1200"
                            ...
                            <div class="featured__column3 swiper">
                                <div class="swiper-wrapper">
                                    	@include('common._item_property',array('db_property'=>$db_property,'from_page'=>'home'))
        ...
        <section class="team__member--section">
            <div class="container">
                                        ...
                                        <div class="team-member-main">
                                            ...
                                            <div class="team__member--content">
                                                <div class="team__member--content__left">
                                                    <h3 class="team__member--title" id="id_broker_name_<?=$row['id']?>"><?=$row['name']?></h3>
       ...
       <?php if(count($rs_agents)>0) {?>
        ...
        <section class="location__section">
            <div class="container">
                <div class="section__heading text-center mb-20" data-aos="fade-up" data-aos-duration="1200"
                    data-aos-delay="100">
                    <h2 class="section__heading--title text-center"><?=$why_choose_dp[0]['heading']?></h2>
                </div>
                        ...
                        <div class="swiper-slide">
                            <article class="blog__items">
                                <div class="blog__thumbnail position-relative">
                                    ...
                                    <a href="<?=$row['page_link']?>" class="video-popup__button"><i
        ...
        @include('partial.quick_links',array('page_id'=>1))
@stop
@section('footer')
