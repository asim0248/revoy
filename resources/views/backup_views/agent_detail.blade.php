...
$db_property = App\Model\Property::whereRaw("status = 'Yes' AND admin_status = 'Yes' AND user_id  = ".$cms_dp['id']."  ")->orderByRaw('id DESC')->get();
...
?>
       ...
       <section class="agent-video-sec">
			...
			if($cms_dp['logo']!=''){
			?>
            <div class="agent-sticky-logo p-0 pt-3" style="background-color:<?=($cms_dp['primary_colour']=='')?'#000':$cms_dp['primary_colour']?> ;">
                <img src="<?= url('/') . '/public/upload/agents/' . $cms_dp['logo'] ?>" style="height: 38px;" alt="">
            </div>
            <?php } ?>
            <?php 
			if($cms_dp['banner']!=''){
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="broker-top-br-btns">
                                            <div class="m-2">
                                                <a href="javascript:void(0)"  class="appraisal-btn"><span><i class="fa-solid fa-envelope"></i></span> Request a free appraisal</a>
                                            </div>
                                            <div class="d-flex">
                                ...
                                <div class="listing__details--wrapper">
                                    ...
                                    <div class="listing__details--content" style="display:none;">
                                        ...
                                        <div class="listing__details--content__step">
                                            <h4 class="fs-3 mb-0 pb-1">Hamish's Performance Snapshot</h4>
                                            <p>
                                    ...
                                    <div class="listing__details--main__content">
                                        ...
                                        <div class="listing__details--content__step mb-40">
                                            ...
                                            <div class="add-detail-text">
                                                <h4 class="fs-3 mb-0 pb-1"><?=$cms_dp['name']?> properties</h4>
                                            <p class="mb-1" style="display:none;">
                                                Properties recently sold by Hamish in the last 12 months.^
                                            </p>
                                            <select class="contact__form--select" style="display:none">
                                            ...
                                            <?php } ?>
                                                ...
                                                <div class="big-add-more">
                                                            ...
                                                            <div class="add-big-main">
                                                                <div class="add-big-img-two">
                                                                    <a href="<?=url('/')?>/detail/<?=$row_p->slug?>-<?=$row_p->id?>.html">
                                                                        <div class="sold-tag"><?=$row_p->property_option->name?></div>
                                                                        <img src="<?= url('/') . '/public/upload/property/'.$row_p->user_id.'/'.$row_p->image?>"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <h4 class="fs-1 mb-0 pb-2"><?=App\Model\Common::priceFormat($row_p->price)?></h4>
                                                    <?php } else {?>
                                                    <h4 class="fs-1 mb-0 pb-2"><?=$row_p->min_price?></h4>
                                                    <?php } ?>
                                                                        ...
                                                                        <ul
                                                                            class="featured__info d-flex mb-4">
                                                    ...
                                                    <div class="agent-getIntouch-btn w-100" style="display:none;">
                                                        <a href="#" class="w-100">View More Listings</a>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="listing__details--content__step properties__amenities mb-40">
                                            ...
                                            <h4 class="fs-3 mb-0 pb-1">About <?=$cms_dp['name']?></h4>
                                        ...
                                        <div class="listing__details--content__step mb-40" style="display:none;">
                                            <div class="listing__details--location__header mb-20">
                                                ...
                                                <div class="auction-main" id="agent-reviews">
                                                    <h4 class="fs-3 mb-0 pb-1">Hamish's reviews</h4>
                                                    <p>
                                                        Read the latest client reviews of Hamish Firth, real estate agent at Ray White Rural Scone - SCONE.
                                                    </p>
                                                    <div class="broker-reviews ">
                                                        <div class="d-flex align-items-center mb-3">
                                                            <img src="assets/img/property/add-1/agent-prof.jpg" alt="Profile Picture" class="rounded-circle me-3" width="50">
                                                            <div>
                                                                <h5 class="mb-0 p-0"><i class="fa-solid fa-star text-warning me-2"></i>5.0 (10 reviews)</h5>
                                                                <p class="mb-0">Partnered with Hamish before? <a href="leave-reply.html" class="leave-reply-link">Leave a review</a></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="review-card mb-3">
                                                            ...
                                                            <p class="mb-0"><strong>Seller of house</strong> in Scone, NSW</p>
                                                            <p class="text-muted mb-0">1 year ago</p>
                                                            <p>Great agent will recommend and honest</p>
                                                        </div>
                                                        ...
                                                        <button class="reviews-btn w-100">Show 10 reviews</button>
                                                    </div>
<style>
    span.verified i {
    background: #ffc50b;
                                            ...
                                            <div class="listing__details--location__header mb-20">
                                                ...
                                                <div class="auction-main">
                                                    ...
                                                    <div class="button-group">
                                                        <button class="option-button">Selling a property</button>
                                                        <button class="option-button">Property management</button>
                                                        <button class="option-button">An advertised property</button>
                                                        <button class="option-button">General enquiry</button>
                                                    </div>
                                    ...
                                    <div class="widget__admin--profile text-center mb-30" >
                                        <div class="add-details-agent-card">
                                            ...
                                            <div class="agent-logo-bar" style="background-color:<?=($cms_dp['primary_colour']=='')?'#000':$cms_dp['primary_colour']?> ;">
                                               <a href="<?=url('/')?>/agents/<?=App\Model\Common::slug($cms_dp['name'])?>-<?=$cms_dp['id']?>.html"><img src="<?= url('/') . '/public/upload/agents/' . $cms_dp['logo'] ?>" alt=""></a>
                                            </div>
                                            <?php } ?>
                                            ...
                                            <div class="broker-top-br-btns broker-side-card">
                                                <div class="m-2">
                                                    <a href="javascript:void(0)" onclick="contact_agent(<?=$cms_dp['id']?>)" class="appraisal-btn"><span><i class="fa-solid fa-envelope"></i></span> Request a free appraisal</a>
                                                </div>
                                                <div class="d-flex">
