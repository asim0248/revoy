...
?>
 <section class="free-estimate-sec loan-req-sec">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="ltn-counter-head">
                            <h2>Australia's favourite property valuation provider
                            </h2>
                        </div>
                    </div>
        ...
        <section class="listing-package-sec listing-bg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
         ...
         <section class="brands-sec">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="package-head">
                            <h2>Our Cooperating Brands</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                	<?php foreach ($rs_brands as $row){?>
                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="brand-img">
                        	<a href="<?=$row['slug']?>">
...
<script type="text/javascript">
 ...
 function contact_us_investment() {
	...
	if ($.trim($("#contact_investment_postcode").val()) == "") {
        $("#contact_investment_postcode").addClass('field_error');
        if (flg == 0) {
            $("#contact_investment_postcode").focus();
        ...
        $("#contact_investment_postcode").removeClass('field_error');
    }
