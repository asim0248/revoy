    ...
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                ...
                <a href="<?= URL::to('admin/outdoorfeatures') ?>">
                    Outdoor Features
                </a>
                <i class="fa fa-angle-right"></i>
            </li>
    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    Edit Outdoor Features
                </div>

            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/outdoorfeatures/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return update_outdoorfeatures(); " enctype="multipart/form-data" >
