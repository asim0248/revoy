    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/brands/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return update_brands(); " enctype="multipart/form-data" >
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="<?= url('/') . '/public/upload/brands/' . $data['image'] ?>" height="100" width="100" />
                                <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?= URL::to('admin/brands') ?>"><button type="button" class="btn default"  > Cancel</button></a>
                        </div>
                    </div>
                </form>
                <!-- END FORM-->
