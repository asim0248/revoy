...
<div class="row">
    <div class="col-md-12">
        <h3 class="page-title"><?=$data['name']?> Images</h3>
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="#"><?=$data['name']?> Images</a></li>
        </ul>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="table-toolbar" style="margin-bottom: 8px;">
            <div class="btn-group pull-right">
                <a href="<?= URL::to('admin/services/createimage/'.md5($data['id'])) ?>"><button id="" type="button" class="btn green">
...
?>
                            <tr class="odd gradeX">
                                ...
                                <td  >
                                   <img src="<?= url('/') . '/public/upload/services/' . $row['image'] ?>" height="100" width="100" />
                                </td>
...
<script type="text/javascript">
    ...
    function delete_record(id,sid) {
        bootbox.confirm('<div class="alert alert-danger alert-error" style="font-size:18px; margin-top: 20px;" >Are you sure you want to delete this ?</div>', function (result) {
            if (result) {
                window.location = "<?= URL::to('admin/services/imagedelete') ?>/" + id+'/'+ sid;
            }
        });
    }
