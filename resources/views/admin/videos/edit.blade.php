...
<?php 
 ...
 $sub_category = App\Model\Videocategory::whereRaw("status = 'Yes' AND pid = ".$data['category_id']." ")->orderByRaw('name')->get()->toArray();
?>
<div class="row">
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/videos/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal"  enctype="multipart/form-data"  >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4" id="result_sub_category">
                                ...
                                <option value="<?=$row['id']?>" <?=($data['sub_category_id']==$row['id'])?'selected':''?>><?=$row['name']?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="https://www.youtube.com/watch?v=VIDEO_KEY" name="video_link" id="video_link" value="<?= $data['video_link'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="page_link" id="page_link" value="<?= $data['page_link'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="file" class="" style="display:none;"  placeholder="" name="image" id="image" value="">								<br /><?php if($data['banner']!="") {?>
                                <img src="<?= url('/') . '/public/upload/videos/' . $data['banner'] ?>" height="100" width="100" />
                                <?php } ?>
                            </div>
                        </div>
