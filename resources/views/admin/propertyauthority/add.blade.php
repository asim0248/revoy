    ...
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                ...
                <a href="<?= URL::to('admin/propertyauthority') ?>">
                    Property Authority
                </a>
                <i class="fa fa-angle-right"></i>
            </li>
    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    Add Property Authority
                </div>

            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/propertyauthority/create_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return create_propertyauthority(); "  enctype="multipart/form-data" >
                    ...
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?= URL::to('admin/propertyauthority') ?>"><button type="button" class="btn default"  > Cancel</button></a>
                        </div>
                    </div>
                </form>
                <!-- END FORM-->
