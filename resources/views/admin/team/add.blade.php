    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/team/create_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" enctype="multipart/form-data"  >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="position" id="position" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="nationality" id="nationality" value="">
                            </div>
                        </div>
