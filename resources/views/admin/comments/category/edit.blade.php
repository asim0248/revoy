...
<?php 
 $category_parent = App\Model\Category::whereRaw("status = 'Yes' AND pid = 0 ")->orderByRaw('name')->get()->toArray();
?>
<div class="row">
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/category/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return update_category(); " enctype="multipart/form-data" >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="<?= url('/') . '/public/upload/category/' . $data['image'] ?>" height="80" />
                                <?php } ?>
                            </div>
                        </div>
                         ...
                         <div class="form-group" style="display:none;">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($data['banner']!="") {?>
                                <img src="<?= url('/') . '/public/upload/category/' . $data['banner'] ?>" height="80"  />
                                <?php } ?>
                    ...
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?= URL::to('admin/category') ?>"><button type="button" class="btn default"  > Cancel</button></a>
                        </div>
                    </div>
                </form>
                <!-- END FORM-->
