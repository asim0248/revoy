    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/finance/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal"  enctype="multipart/form-data"  >
                    ...
                    <div class="form-body">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="link_heading" id="link_heading" value="<?= $data['link_heading'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="<?= url('/') . '/public/upload/finance/' . $data['image'] ?>" height="80" />
                                <?php } ?>
                            </div>
                        </div>
