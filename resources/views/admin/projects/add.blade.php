    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/projects/create_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" enctype="multipart/form-data"  >
...
?>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group" style="display:none;">
                            ...
                            <div class="col-md-4">
                                <input type="date" class="form-control"  placeholder="" name="project_date" id="project_date" value="<?=old('project_date')?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group"  style="display:none;">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea  name="short_contents" class="form-control"  id="short_contents"><?=old('short_contents')?></textarea>
                            </div>
                        </div>
