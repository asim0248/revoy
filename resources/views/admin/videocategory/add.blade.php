    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/videocategory/create_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return create_category(); "  enctype="multipart/form-data" >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="icon" id="icon" value="">
                            </div>
                        </div>
