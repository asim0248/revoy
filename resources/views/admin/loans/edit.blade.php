    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/loans/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal"  enctype="multipart/form-data"  >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" >
                         ...
                         <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="blog_title" id="blog_title" value="<?= $data['blog_title'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <span style="background:#CCC; float:left;"><img src="<?= url('/') . '/public/upload/loans/' . $data['image'] ?>" height="80" /></span>
                                <?php } ?>
                            </div>
                        </div>
                        
                        <div class="form-group" >
                            <label class="col-md-3 control-label">Icon Detail </label>
                            <div class="col-md-4">
                            	<button type="button" id="id_upload_3" class="btn btn-success btn-block" > <i class="fa fa-upload"></i> Upload</button>
                                <input type="file" class="" style="display:none;"  placeholder="" name="image_3" id="image_3" value="">								<br /><?php if($data['image_3']!="") {?>
                                <img src="<?= url('/') . '/public/upload/loans/' . $data['image_3'] ?>" height="80" />
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                               ...
                               <span style="background-color:#CCC;"> <img src="<?= url('/') . '/public/upload/loans/' . $data['image_2'] ?>" height="80" /></span>
                                <?php } ?>
                            </div>
                        </div>
                         ...
                         <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($data['banner']!="") {?>
                               <span style="background-color:#CCC;"> <img src="<?= url('/') . '/public/upload/loans/' . $data['banner'] ?>" height="80" /></span>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group"  >
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control"  placeholder="" name="video_detail" id="video_detail"><?= $data['video_detail'] ?></textarea>
