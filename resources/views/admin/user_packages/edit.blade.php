                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="package_name" name="package_name" value="<?= $data_package['package_name'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="amount" name="amount" value="<?= $data_package['amount'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="<?= url('/') . '/public/upload/invoice/' . $data['image'] ?>" download>Download</a>
                                <?php } ?>
                            </div>
                        </div>
