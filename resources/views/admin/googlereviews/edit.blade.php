    ...
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                ...
                <a href="<?= URL::to('admin/googlereviews') ?>">
                    Google Reviews
                </a>
                <i class="fa fa-angle-right"></i>
            </li>
    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/googlereviews/edit_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return update_googlereviews(); " enctype="multipart/form-data" >
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group"  >
                            ...
                            <div class="col-md-4">
                                ...
                                <img src="<?= url('/') . '/public/upload/googlereviews/' . $data['image'] ?>" height="100" width="100" />
                                <?php } ?>
                            </div>
                        </div>
                        
                        <div class="form-group"  style="display:none;" >
                            <label class="col-md-3 control-label">Content Heading</label>
                            <div class="col-md-8">
                  <input type="text" class="form-control"  placeholder="" name="heading_contents" id="heading_contents" value="<?= $data['heading_contents'] ?>">
                    ...
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?= URL::to('admin/googlereviews') ?>"><button type="button" class="btn default"  > Cancel</button></a>
                        </div>
                    </div>
                </form>
                <!-- END FORM-->
