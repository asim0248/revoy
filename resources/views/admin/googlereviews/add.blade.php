    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?= URL::to('admin/googlereviews/create_save') ?>" method="post" name="form_data" id="form_data"  class="form-horizontal" onsubmit="return create_googlereviews(); "  enctype="multipart/form-data" >
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"  placeholder="" name="rating" id="rating" value="5">
                            </div>
                        </div>
                        ...
                        <div class="form-group"  style="display:none;"  >
                            ...
                            <div class="col-md-8">
                  <input type="text" class="form-control"  placeholder="" name="heading_contents" id="heading_contents" value="">
