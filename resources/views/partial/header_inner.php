...
$is_mobile = false;
//header-about
$show_bg_class = 'header__section_BG';

$slus_array = array('legal','privacy-center');

if (in_array($slug, $slus_array)) {
   $show_bg_class = '';
}

?>
<header class="header__section color-accent-2 <?=$show_bg_class?> ">
            ...
            <div class="container max-w-1430">
                <div class="main__header d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="<?php echo URL::to('/'); ?>">
