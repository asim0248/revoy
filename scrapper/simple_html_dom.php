	...
	$defaultSpanText = DEFAULT_SPAN_TEXT)
{
	...
	/*$contents = file_get_contents(
	 ...
	 $contents = retrieve_url_contents_live($url);
...
function retrieve_url_contents_live($url, $maxLen = 500000)
{
   $url = $url;
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_USERAGENT, "Mozilla/5.0 (compatible; MyCrawler/1.0)");
